...
data, labelsA = load_csv('clus_ij_training_2.5_1.5.csv', target_column=0,
                        categorical_labels=True, n_classes=2)
input, labelsB = load_csv('clus_ij_test_2.5_1.5.csv', target_column=0,
                        categorical_labels=True, n_classes=2)
...
# Test Data
BJet = [34.2951875, 7.333956473, 0.2012983631, 0.3016923363, 26.21205357]
SJet = [108.2018956, 13.25820691, 0.1506504458, 0.4147143388, 28.58320951]
...
with open('/Users/Anne-Katherine/Desktop/ATLAS_ML/clus_ij_out_15_25.csv','wb') as f:
