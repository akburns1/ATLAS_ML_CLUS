...
data, labelsA = load_csv('clus_tc_training_0_1.5.csv', target_column=0,
                        categorical_labels=True, n_classes=2)
input, labelsB = load_csv('clus_tc_test_0_1.5.csv', target_column=0,
                        categorical_labels=True, n_classes=2)
...
with open('/Users/Anne-Katherine/Desktop/ATLAS_ML/clus_tc_out_0_15.csv','wb') as f:
