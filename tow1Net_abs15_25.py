...
data, labelsA = load_csv('clus_tj_training_2.5_1.5.csv', target_column=0,
                        categorical_labels=True, n_classes=2)
input, labelsB = load_csv('clus_tj_test_2.5_1.5.csv', target_column=0,
                        categorical_labels=True, n_classes=2)
...
with open('/Users/Anne-Katherine/Desktop/ATLAS_ML/clus_tj_out_15_25.csv','wb') as f:
